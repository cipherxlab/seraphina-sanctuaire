export const fr = {
  ...
  enterBtn: "✨ ENTRER DANS LA LUMIÈRE ✨",
  welcomeTitle: "Bienvenue dans la Lumière",
  welcomeMessage: "Que la paix et l'amour de Dieu illuminent votre cœur. Vous êtes maintenant dans un espace sacré de contemplation et d'émerveillement."
};
